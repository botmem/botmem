...
| `diversityFactor`         | number | No       | Connector diversity threshold (0-1, default: 0.15). Higher values sacrifice more score for diversity across connector types. 0 disables diversity ordering. |
