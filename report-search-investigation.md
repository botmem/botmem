...
5. **Score capping at 1.0** — NEW FINDING. `Math.min(score + textBoost + contactBoost, 1.0)` destroys ranking for FTS-matched results. All "pet insurance claim" results have identical score=1.000.
