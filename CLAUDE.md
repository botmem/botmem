...
| `OLLAMA_EMBED_MODEL`      | `mxbai-embed-large`                   | Embedding model (1024d) — code default; .env.example uses `nomic-embed-text` (768d) |
| `OLLAMA_TEXT_MODEL`       | `qwen3:8b`                            | Text enrichment model — code default; .env.example uses `qwen3:0.6b`                |
| `OLLAMA_VL_MODEL`         | `qwen3-vl:4b`                         | Vision-language model — code default; .env.example uses `qwen3-vl:2b`               |
