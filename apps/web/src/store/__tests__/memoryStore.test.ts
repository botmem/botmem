...
const sampleMemories = [
  {
    ...
    weights: { semantic: 0.8, recency: 0.5, importance: 0.7, trust: 0.8, final: 0.7 },
  ...
  },
  {
    ...
    weights: { semantic: 0.5, recency: 0.3, importance: 0.3, trust: 0.7, final: 0.4 },
    entities: [],
    claims: [],
    metadata: {},
    pinned: false,
  },
  {
    ...
    weights: { semantic: 0.3, recency: 0.2, importance: 0.95, trust: 0.9, final: 0.5 },
    entities: [],
    claims: [],
    metadata: {},
    pinned: false,
